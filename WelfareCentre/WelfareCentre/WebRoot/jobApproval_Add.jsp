...
<div id="content" class="white">
  <h1><img src="img/icons/posts.png" alt="" /> 招聘需求审批</h1>
  <div class="bloc">
    <form action="" method="post">
      <div class="title">需求审批</div>
      <div class="content">
        <div class="input">
          <label for="select">需求部门</label>
        ...
        <div class="input">
          <label for="input1">预计用人时间</label>
          <input type="text" class="datepicker" style="width: 120px" />
        </div>
        <div class="input">
          <label for="input1">需求人数</label>
          <input type="text" class="text" />
        </div>
        
        <div class="input textarea">
          <label for="textarea1">职业需求描述</label>
        ...
        <div class="input">
          <label for="input1">审核结果</label>
          <input name="do" type="checkbox" values="不同意">
              不同意
